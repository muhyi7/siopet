 ...
 * @author lenovo
 */
public class FPinberhasil extends javax.swing.JFrame {

    /**
     * Creates new form FPinberhasil
     */
    public FPinberhasil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notif/login/Pinberhasil.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FPinberhasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FPinberhasil().setVisible(true);
            }
        });
    }
