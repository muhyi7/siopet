 ...
 * @author lenovo
 */
public class Floginberhasilowner extends javax.swing.JFrame {

    /**
     * Creates new form Floginberhasilowner
     */
    public Floginberhasilowner() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Floginberhasilowner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Floginberhasilowner().setVisible(true);
            }
        });
    }
