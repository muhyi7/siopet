 ...
 * @author lenovo
 */
public class Fpasswordkurang extends javax.swing.JFrame {

    /**
     * Creates new form Fpasswordkurang
     */
    public Fpasswordkurang() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notif/login/passwordkurang.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fpasswordkurang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fpasswordkurang().setVisible(true);
            }
        });
    }
