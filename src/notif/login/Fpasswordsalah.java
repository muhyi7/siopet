 ...
 * @author lenovo
 */
public class Fpasswordsalah extends javax.swing.JFrame {

    /**
     * Creates new form Fpasswordsalah
     */
    public Fpasswordsalah() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fpasswordsalah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fpasswordsalah().setVisible(true);
            }
        });
    }
