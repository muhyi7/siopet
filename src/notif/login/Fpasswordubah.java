 ...
 * @author lenovo
 */
public class Fpasswordubah extends javax.swing.JFrame {

    /**
     * Creates new form Fpasswordubah
     */
    public Fpasswordubah() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/notif/login/passwordberhasildiubah.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fpasswordubah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Fpasswordubah().setVisible(true);
            }
        });
    }
